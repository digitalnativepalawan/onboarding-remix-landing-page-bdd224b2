          ...
          <div className="glass-card p-5 sm:p-6">
            <div className="flex items-start gap-3 mb-5">
              ...
              <div>
                ...
                <p className="text-foreground/80 text-xs sm:text-sm leading-relaxed">{t("howItWorks.cloudbedsDescription")}</p>
              </div>
            </div>
              ...
              {features.map((feature) => (
                <div key={feature.titleKey} className="flex items-start gap-2.5 p-3 rounded-lg bg-muted/20 border border-border/20">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-[0.65rem] text-foreground/70 leading-tight">{t(feature.descKey)}</p>
                  </div>
                </div>
              ))}
            </div>

            <div className="mt-5 pt-4 border-t border-border/20 flex items-center justify-center gap-2 text-foreground/60">
