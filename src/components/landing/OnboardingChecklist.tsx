      ...
      <div className="px-5 sm:px-6 max-w-2xl mx-auto">
        ...
        <div className="space-y-2.5">
          {checklistItems.map((item, index) => (
            ...
            >
              {/* Step Number */}
              <div className="w-6 h-6 rounded-full bg-muted/50 flex items-center justify-center text-xs text-foreground/70 font-medium shrink-0">
                {index + 1}
              </div>
        ...
        {/* Footer Note */}
        <p className="text-xs text-foreground/60 text-center mt-5 font-light">
