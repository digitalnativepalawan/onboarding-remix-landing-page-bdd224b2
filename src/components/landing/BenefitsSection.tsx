      ...
      <div className="px-5 sm:px-6">
        <div className="max-w-3xl mx-auto">
            ...
            {benefits.map((benefit) => (
              <div key={benefit.titleKey} className="flex items-start gap-3 p-4 rounded-lg bg-card/40 border border-border/20">
                ...
                <div>
                  ...
                  <p className="text-xs text-foreground/70 leading-relaxed">{t(benefit.descKey)}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="p-4 rounded-lg border border-border/20 bg-card/20 text-center">
            ...
            <p className="text-xs text-foreground/70 max-w-sm mx-auto leading-relaxed">{t("benefits.offlineDescription")}</p>
          </div>
        </div>
      </div>
    </section>
