...
export default function QuotesPage() {
  ...
  const openEdit = async (id: string) => {
    ...
    setEditDraft({
      ...
      payment_cash_enabled: q.payment_cash_enabled ?? true,
      payment_gcash_enabled: q.payment_gcash_enabled ?? true,
      payment_gcash_number: q.payment_gcash_number,
      payment_qr_enabled: q.payment_qr_enabled ?? true,
      payment_qr_url: q.payment_qr_url,
      payment_bank_enabled: q.payment_bank_enabled ?? true,
      payment_bank_name: q.payment_bank_name,
      payment_bank_account_name: q.payment_bank_account_name,
      payment_bank_account_number: q.payment_bank_account_number,
